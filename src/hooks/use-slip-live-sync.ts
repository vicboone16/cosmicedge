...
const STAT_MAP: Record<string, string[]> = {
  ...
  three_made: ["three_made"], "3pm": ["three_made"], threes: ["three_made"], player_threes: ["three_made"],
  ...
  player_steals_blocks: ["steals", "blocks"], "blks+stls": ["steals", "blocks"],
  fantasy_points: ["fantasy_points"], fantasy: ["fantasy_points"],
  "fantasy score": ["fantasy_points"], fantasy_score: ["fantasy_points"],
  fg_made: ["fg_made"], ft_made: ["ft_made"], minutes: ["minutes"],
  fouls: ["personal_fouls"], personal_fouls: ["personal_fouls"],
  player_field_goals: ["fg_made"], player_triple_double: ["points"],
