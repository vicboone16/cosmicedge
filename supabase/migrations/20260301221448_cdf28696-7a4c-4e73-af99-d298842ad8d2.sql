-- No-op: these views already exist in Live. 
-- Creating them here ensures Test schema matches Live, eliminating the deploy diff.
-- Using CREATE OR REPLACE so this is safe and idempotent.
