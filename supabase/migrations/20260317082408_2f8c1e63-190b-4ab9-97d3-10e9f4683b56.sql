...
-- Sync migration state: declare security_invoker=true on all 83 public views
-- These were applied to production out-of-band; this migration records the intent
-- so the diff system stops trying to revert them via DROP+CREATE.
