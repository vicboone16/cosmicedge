...
-- Drop the old function and its dependent views cleanly
...
DROP FUNCTION IF EXISTS public.american_to_break_even_prob(integer) CASCADE;

-- Recreate tt_admin_dashboard without the function dependency (inline CTE)
