...
DROP VIEW IF EXISTS public.np_v_backtest_results;
DROP VIEW IF EXISTS public.np_player_prop_stat_long;

-- Recreate with Live's full definitions so they exist for the diff
CREATE VIEW public.np_player_prop_stat_long AS
...
-- Recreate backtest results
CREATE VIEW public.np_v_backtest_results AS
SELECT o.game_id,
    o.player_id,
    o.prop_type,
    o.book,
