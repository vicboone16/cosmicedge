-- No-op: all views already exist in DB, this migration resolves schema diff
-- Recreate v_nfl_player_game_metrics to clear the s.player_id schema diff error
...
-- Recreate v_nfl_player_quarter_metrics
